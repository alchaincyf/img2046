...
const colorSchemes: ColorSchemes = {
  莫兰迪: [
    { name: '沙漠米色', colors: ['#E0D4C3'] },
    { name: '淡灰棕', colors: ['#D1C2B3'] },
    { name: '浅木色', colors: ['#C2B0A3'] },
    { name: '灰褐色', colors: ['#B39E93'] },
    { name: '深灰棕', colors: ['#A48C83'] },
    { name: '烟灰色', colors: ['#957A73'] },
    { name: '深烟灰', colors: ['#866863'] },
    { name: '褐灰色', colors: ['#775653'] },
    { name: '深褐灰', colors: ['#684443'] },
    { name: '暗红褐', colors: ['#593333'] },
    { name: '深红褐', colors: ['#4A2223'] },
    { name: '暗酒红', colors: ['#3B1113'] },
    { name: '深酒红', colors: ['#2C0003'] },
    { name: '黑红色', colors: ['#1D0000'] },
  ],
  渐变: [
